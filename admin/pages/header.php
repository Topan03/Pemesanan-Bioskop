...
$th=mysqli_query($conn,"select * from teater where id='".$_SESSION['theatre']."'");
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>ADMIN</b> <?php echo $theatre['nama'];?></php></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="ajax-loader.gif" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $theatre['nama'];?></span>
            </a>
