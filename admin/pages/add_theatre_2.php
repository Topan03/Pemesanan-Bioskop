    ...
    <section class="content">
      ...
      <div class="box">
          ...
          ?>
            <table class="table table-bordered table-hover">
                <tr>
                    ...
                    <td  class="col-md-6"><?php echo $theatre['nama'];?></td>
                </tr>
                <tr>
                    <td>Theater Address</td>
                    <td><?php echo $theatre['alamat'];?></td>
                </tr>
                <tr>
                    <td>Place</td>
                    <td><?php echo $theatre['tempat'];?></td>
                </tr>
                <tr>
                    <td>State</td>
                    <td><?php echo $theatre['kota'];?></td>
                </tr>
                <tr>
                    <td>Pin</td>
        ...
        <div class="box-body" id="screendtls">
          <?php
            $sr=mysqli_query($conn,"select * from screens where t_id='".$_SESSION['theatre']."'");
