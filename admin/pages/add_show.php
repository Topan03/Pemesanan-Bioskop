          ...
          <form action="process_addshow.php" method="post" id="form1">
            <div class="form-group">
              ...
              <select name="movie" class="form-control">
                ...
                <?php
                  $mv=mysqli_query($conn,"select * from film where status='0'");
                  while($movie=mysqli_fetch_array($mv))
                  {
                    ?>
                    <option value="<?php echo $movie['film_id'];?>"><?php echo $movie['judul_film']; ?></option>
                    <?php
                  }
                ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select name="screen" class="form-control" id="screen">
                ...
                <?php
                  $sc=mysqli_query($conn,"select * from screens where t_id='".$_SESSION['theatre']."'");
                  while($screen=mysqli_fetch_array($sc))
                  {
                    ?>
                    <option value="<?php echo $screen['screen_id']; ?>"><?php echo $screen['nama_screen']; ?></option>
                    <?php
                  }
                ?>
              </select>
