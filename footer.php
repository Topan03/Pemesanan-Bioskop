			...
			<div class="footer-top">
				...
				<div class="col_1_of_4 span_1_of_4">
					<div class="call_info">
						...
						<p class="txt_4">0895 3924 76070</p>
					</div>
					<br>
					<br>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class=social>
						...
						<a href="https://x.com/?lang=en-id"><img src="images/tw.png" alt=""/></a>
						<a href="https://dribbble.com/"><img src="images/dribble.png" alt=""/></a>
        ...
        var demo1 = new autoComplete({
            ...
            source: function(term, suggest){
               ...
               var string="";
                ...
                $string .="'".strtoupper($ss['judul_film'])."'".",";
